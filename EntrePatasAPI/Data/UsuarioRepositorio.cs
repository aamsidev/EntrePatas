    ...
    public class UsuarioRepositorio : IUsuario
    {
        ...
        public List<Usuario> Listado()
        {
            ...
            using (var conexion = new SqlConnection(cadenaConexion))
            {
                ...
                using (var command = new SqlCommand("sp_ObtenerUsuarios", conexion))
                {
        ...
        public Usuario ObtenerUsuarioPorId(int id)
        {
            ...
            {
                conexion.Open();
                using (var command = new SqlCommand("sp_ObtenerUsuariosPorId", conexion))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public Usuario RegistrarAdmin(UsuarioDTO usuario)
        {
            Usuario? nuevoUsuario = null;
            if (nuevoUsuario == null)
            {
            ...
            {
                conexion.Open();
                using (var command = new SqlCommand("sp_InsertarAdmin", conexion))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Nombre", usuario.Nombre);
                    command.Parameters.AddWithValue("@Apellido", usuario.Apellido);
